 ...
 * - Finds all unpaid fines issued more than 30 days ago
 ...
 * Updates all unpaid fines issued 30+ days ago to 'outdated' status
 *
...
export const markFinesAsOutdated = async () => {
  try {
    ...
    console.log(`[CRON] Marking fines as outdated (issued before ${thirtyDaysAgo})...`);

    // Update all unpaid fines issued more than 30 days ago
...
export const getFineSchedulerStatus = (task) => {
  return {
    ...
    description: 'Marks unpaid fines issued 30+ days ago as outdated',
  };
};
